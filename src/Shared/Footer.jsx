                            ...
                            <div className="col-span-8 border-r border-gray-100  md:col-span-2 lg:col-span-3">
                                ...
                                >
                                    ...
                                    <div className="flex gap-6">
                                        <Link target="blank" aria-label="github" className="hover:text-cyan-600">
                                            <svg
                                        ...
                                        <Link target="blank" aria-label="twitter" className="hover:text-cyan-600">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="20"
                                                height="20"
                                        ...
                                        <Link target="blank" aria-label="medium" className="hover:text-cyan-600">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="20"
                                                height="20"
                                ...
                                <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:pl-16">
                                    <div>
                                        ...
                                        <ul className="mt-4 list-inside space-y-4">
                                            <li>
                                                <Link className="transition hover:text-cyan-600">About</Link>
                                            </li>
                                            <li>
                                                <Link className="transition hover:text-cyan-600">Customers</Link>
                                            </li>
                                            <li>
                                                <Link className="transition hover:text-cyan-600">Enterprise</Link>
                                            </li>
                                            <li>
                                                <Link className="transition hover:text-cyan-600">Partners</Link>
                                            </li>
                                            <li>
                                                <Link className="transition hover:text-cyan-600">Jobs</Link>
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <h6 className="text-lg font-medium text-gray-800 ">Resources</h6>
                                        <ul className="mt-4 list-inside space-y-4">
                                            <li>
                                                <Link className="transition hover:text-cyan-600">About</Link>
                                            </li>
